---
title: "Explicit RAG That the Developer Controls"
...
tags:
  ...
  - RAG
  - Context
slug: explicit-rag-that-the-developer-controls
description: A cold Claude instance looked at msw-lens and said "this is just explicit RAG that the developer controls" — and that one sentence reframed the whole project.
---
...
[msw-lens](https://github.com/jeffrygonzalez/msw-tui) has a `lens:context` command. You point it at a component file. It generates a prompt.
